...
const HomeSection = ({ CV }) => {
  ...
  <div className="flex flex-col items-start justify-start p-12 md:px-16">
    <h2 className="text-2xl font-medium text-white lg:text-4xl">Hey there, I'm</h2>
    <h1 className="text-6xl font-bold text-white">Chamara<span className='text-purple-500'>.</span></h1>
